/*
  ...
  - Made the column `organizationId` on table `checkpoint_config` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `checkpoints` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `help_request_responses` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `help_requests` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `notifications` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `role_notification_configs` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `tickets` required. This step will fail if there are existing NULL values in that column.
  - Made the column `organizationId` on table `tv_config` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_checkpoint_config" ("activeHoursEnd", "activeHoursStart", "id", "intervalMinutes", "isEnabled", "organizationId") SELECT "activeHoursEnd", "activeHoursStart", "id", "intervalMinutes", "isEnabled", "organizationId" FROM "checkpoint_config";
...
INSERT INTO "new_checkpoints" ("createdAt", "currentTask", "id", "isBlocked", "notes", "organizationId", "userId") SELECT "createdAt", "currentTask", "id", "isBlocked", "notes", "organizationId", "userId" FROM "checkpoints";
...
INSERT INTO "new_help_request_responses" ("helpRequestId", "id", "organizationId", "respondedAt", "responderId") SELECT "helpRequestId", "id", "organizationId", "respondedAt", "responderId" FROM "help_request_responses";
...
INSERT INTO "new_help_requests" ("contextMessage", "createdAt", "id", "organizationId", "requestedById") SELECT "contextMessage", "createdAt", "id", "organizationId", "requestedById" FROM "help_requests";
...
INSERT INTO "new_notifications" ("acknowledgedAt", "body", "createdAt", "id", "isRead", "organizationId", "requiresAck", "ticketId", "title", "type", "userId") SELECT "acknowledgedAt", "body", "createdAt", "id", "isRead", "organizationId", "requiresAck", "ticketId", "title", "type", "userId" FROM "notifications";
...
INSERT INTO "new_role_notification_configs" ("id", "notifyOnAssignment", "notifyOnCreation", "organizationId", "role", "updatedAt") SELECT "id", "notifyOnAssignment", "notifyOnCreation", "organizationId", "role", "updatedAt" FROM "role_notification_configs";
...
INSERT INTO "new_tickets" ("assignedToId", "createdAt", "deadline", "description", "id", "openedById", "organizationId", "priorityOrder", "publicId", "resolvedAt", "severity", "status", "title", "type", "updatedAt") SELECT "assignedToId", "createdAt", "deadline", "description", "id", "openedById", "organizationId", "priorityOrder", "publicId", "resolvedAt", "severity", "status", "title", "type", "updatedAt" FROM "tickets";
DROP TABLE "tickets";
...
INSERT INTO "new_tv_config" ("id", "isEnabled", "organizationId", "refreshInterval") SELECT "id", "isEnabled", "organizationId", "refreshInterval" FROM "tv_config";
...
INSERT INTO "new_users" ("avatarUrl", "createdAt", "currentTask", "devStatus", "email", "id", "isActive", "isSuperAdmin", "name", "ninjaAlias", "notifyBugs", "notifyTickets", "organizationId", "passwordHash", "role", "soundEnabled", "updatedAt") SELECT "avatarUrl", "createdAt", "currentTask", "devStatus", "email", "id", "isActive", "isSuperAdmin", "name", "ninjaAlias", "notifyBugs", "notifyTickets", "organizationId", "passwordHash", "role", "soundEnabled", "updatedAt" FROM "users";
DROP TABLE "users";
